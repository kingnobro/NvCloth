...
DECLARE_SCENE_NAME(ClothScene, "Cloth Scene")

void ClothScene::Animate(double dt)
{
...
void ClothScene::initializeCloth(int index, physx::PxVec3 offset)
{
	mOffset = offset;
